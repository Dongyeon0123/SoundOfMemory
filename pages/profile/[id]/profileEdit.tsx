...
const SOCIAL_FIELDS = [ 
  ...
  { key: 'twitterUrl', label: 'X', placeholder: '사용자명 입력', inputType: 'text', baseUrl: 'https://x.com/' },
  ...
  { key: 'notionUrl', label: '노션', placeholder: '전체 URL을 입력하세요', inputType: 'text', baseUrl: 'https://www.notion.so/' },
